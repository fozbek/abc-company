 ...
 */
final class Version20200508155210 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, product_id_id INT DEFAULT NULL, order_code VARCHAR(255) DEFAULT NULL, quantity INT DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, shipping_date DATETIME DEFAULT NULL, INDEX IDX_F5299398DE18E50B (product_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
